...
clean:
	del /Q main.o src\app\processes\ProcessManagement.o src\app\fileHandling\IO.o src\app\fileHandling\ReadEnv.o src\app\encryptDecrypt\Cryption.o src\app\encryptDecrypt\CryptionMain.o encrypt_decrypt.exe cryption.exe
